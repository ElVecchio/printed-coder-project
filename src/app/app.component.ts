...
export class AppComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    //this.articles_sums.push({ picture:"./../assets/news-thumbs-4.png", title:"A Revolução dos Data Lakes", content:"Imagine uma imensa quantidade de dados textuais que se fossem páginas impressas seria capaz de dar 3 mil voltas ao redor do planeta. "});
